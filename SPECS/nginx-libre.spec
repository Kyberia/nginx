...
Source10: http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-%{libressl_version}.tar.gz
...
a mail proxy server. Built for kyberia with lastest openssl to 
support modern crapto.
...
./configure \
        ...
        --with-openssl-opt="no-asm -Wa,--noexecstack -DPURIFY $RPM_OPT_FLAGS" \
        --with-ld-opt="-Wl,-E,-lrt" \
        --with-cc-opt="$RPM_OPT_FLAGS $(pcre-config --cflags)" \
        $*
make %{?_smp_mflags}
...
* Thu Oct 03 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.11.5
- bump libressl to 2.5.0

* Wed Oct 02 2016 Radovan Putec <rdvn@me.com>
- add add rpm build flags
- add -Wa,--noexecstack here so that libcrypto's assembler modules will be marked as not requiring an executable stack
- Also add -DPURIFY to make using valgrind with openssl easier as we do not want to depend on the uninitialized memory as a source of entropy anyway

* Wed Aug 03 2016 Radovan Putec <rdvn@me.com>
- bump libressl to 2.4.2

* Wed Jul 27 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.11.3
- bump libressl to 2.4.1

* Thu Jun 2 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.11.1
- bump libressl to 2.4.0

* Wed May 4 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.15
- bump libressl to 2.3.4

* Tue Apr 5 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.14

* Mon Mar 7 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.13
- bump libressl to 2.3.3

* Wed Feb 10 2016 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.11
- bump libressl to 2.3.2

* Wed Dec 09 2015 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.9
- bump libressl to 2.2.5

* Thu Nov 19 2015 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.7

* Tue Oct 27 2015 Radovan Putec <rdvn@me.com>
- bump to nginx 1.9.6

* Mon Oct 19 2015 Radovan Putec <rdvn@me.com>
- downgrade to libressl 2.2.4 due to CVE-2015-5333 and CVE-2015-5334

* Thu Oct  3 2015 Radovan Putec <rdvn@me.com>
- switch to libressl 2.3.0

* Thu Sep 24 2015 Radovan Putec <rdvn@me.com>
- bump nginx to 1.9.5
- bump openssl to 1.0.2d

* Sun Jun 14 2015 Radovan Putec <rdvn@me.com>
- bump nginx 1.8.0
- bump openssl to 1.0.2c

* Thu Jan 08 2015 Radovan Putec <rdvn@me.com>
- bump openssl to 1.0.1k

* Sat Oct 18 2014 Radovan Putec <rdvn@me.com>
- added static openssl
- added spdy module
